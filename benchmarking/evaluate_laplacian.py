...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the MLP Laplacian hidden-width sweep for fixed AD methods.",
    )
    ...
    parser.add_argument(
        "--output",
        type=Path,
        default=REPO_ROOT / "mlp_laplacian_results.jsonl",
    )
...
def run_one(
    *,
    ...
    workload = make_mlp_laplacian_workload(
